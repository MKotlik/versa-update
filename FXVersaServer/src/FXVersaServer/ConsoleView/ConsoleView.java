...
package FXVersaServer.ConsoleView;
...
public class ConsoleView extends AnchorPane{
    ...
    //Constructor
    public ConsoleView() {
        FXMLLoader loaderCons = new FXMLLoader(getClass().getResource("ConsoleView.fxml"));
        loaderCons.setRoot(this);
        loaderCons.setController(this);
        try {
            loaderCons.load();
